...
class Status(models.Model):
    name = models.CharField(max_length=255)  # Don't forget to specify max_length for CharFields
...
class Service(models.Model):
    ...
    status = models.ForeignKey(Status, related_name='services', on_delete=models.CASCADE)
...
class Report(models.Model):
    ...
    status = models.ForeignKey(Status, related_name='reports', on_delete=models.CASCADE, null=True)
